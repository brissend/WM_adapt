...
if (!file.exists('WM_adapt/data/exp4/exp4_nosaccade_stim_group_mean_fixed.csv')) {
  write.csv(mndf_nosaccade_stim,
            file = 'WM_adapt/data/exp4/exp4_nosaccade_stim_group_mean_fixed.csv',
            row.names = F)
}
...
# save 
if (!file.exists('WM_adapt/data/exp4/exp4_nosaccade_delay_group_mean_fixed.csv')) {
  write.csv(mndf_nosaccade_delay,
            file = 'WM_adapt/data/exp4/exp4_nosaccade_delay_group_mean_fixed.csv',
            row.names = F)
}
